const { Wallet, Signer, BigNumber } = require( 'ethers' ),
    ...
    { Token, PlatformManagement, V1NodeManagement, V2NodeManagement, V1Distribution, V2Distribution } = require( './Contracts.cjs' );
module.exports = {}
module.exports.ContractCommander = class ContractCommander {
...
module.exports.SerializedCommanderInstance = class SerializedCommanderInstance {
    rpcUrl;
    walletAddress;
    isSigner;
