...
export class ContractCommander {
	...
	async balance( address = this.Wallet.address, debug = false ): Promise< string > {
	...
	async transferTo( address: string, amount: string | number, debug = false ): Promise< boolean > {
	...
	async getAllNodes( account = this.Wallet.address, debug = false ): Promise< NodeEntity[] > {
