...
export default class V1NodeManagementInterface extends ContractFunctionsInterface {
	...
	/**
	 * @type { ( address: string, creationTime: BigNumber ) => Promise< BigNumber[] > & ContractFunction< BigNumber[] > }
	 */
	_cashoutNodeReward
	...
	/**
	 * @type { ( value: BigNumber ) => Promise< void[] > & ContractFunction< void[] > }
	 */
	_changeGasDistri
	...
	/**
	 * @type { ( address: string ) => Promise< string[] > & ContractFunction< string[] > }
	 */
	...
	/**
	 * @type { ( address: string ) => Promise< BigNumber[] > & ( ( address: string, creationTime: BigNumber ) => Promise< BigNumber[] > ) & ContractFunction< BigNumber[] > }
	 */
	_getRewardAmountOf
	...
	/**
	 * @type { ( address: string, name: string ) => Promise< void[] > & ContractFunction< void[] > }
	 */
	createNode
